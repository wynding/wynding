...
is welcome too. This document is the **tool-agnostic playbook** — the *process* is the
...
*tooling*, not project code, so we don't vendor them. Install what your harness needs
locally.
