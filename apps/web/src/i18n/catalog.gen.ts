...
export const EN = {
  ...
  "panel.details.label": "Tower details",
...
export interface MessageParams {
  ...
  "panel.details.label": Record<never, never>;
  ...
  "panel.glance.singleUse": Record<never, never>;
  "panel.glance.slow": { "percent": string | number; "duration": string | number };
  "panel.glance.stun": { "chance": string | number; "duration": string | number };
  "panel.glance.support": { "percent": string | number };
  "panel.glance.targets": { "targets": string | number };
  "panel.glance.triggerRange": { "tiles": string | number };
